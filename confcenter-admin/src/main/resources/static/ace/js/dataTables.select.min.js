...
!function (a) {
    ...
    function e(a, b, c) {
        ...
        a.cells({selected: !0}).any() || c ? (e = g(c.column, b.column), f = h(c.row, b.row)) : (e = g(0, b.column), f = h(0, b.row)), d = a.cells(f, e).flatten(), a.cells(b, {selected: !0}).any() ? a.cells(d).deselect() : a.cells(d).select()
    }

    function f(b) {
        var c = b.settings()[0], d = c._select.selector;
        a(b.table().body()).off("mousedown.dtSelect", d).off("mouseup.dtSelect", d).off("click.dtSelect", d), a("body").off("click.dtSelect")
    }

    function g(c) {
        var d = a(c.table().body()), e = c.settings()[0], f = e._select.selector;
        d.on("mousedown.dtSelect", f, function (a) {
            a.shiftKey && d.css("-moz-user-select", "none").one("selectstart.dtSelect", f, function () {
                return !1
            })
        }).on("mouseup.dtSelect", f, function (a) {
            d.css("-moz-user-select", "")
        }).on("click.dtSelect", f, function (d) {
            var e, f = c.select.items();
            if (!b.getSelection || !b.getSelection().toString()) {
                var g = c.settings()[0];
                if (a(d.target).closest("div.dataTables_wrapper")[0] == c.table().container()) {
                    var h = a(d.target).closest("td, th"), i = c.cell(h).index();
                    c.cell(h).any() && ("row" === f ? (e = i.row, m(d, c, g, "row", e)) : "column" === f ? (e = c.cell(h).index().column, m(d, c, g, "column", e)) : "cell" === f && (e = c.cell(h).index(), m(d, c, g, "cell", e)), g._select_lastCell = i)
                }
            }
    ...
    function i(b) {
        ...
        if (c._select.info && c.aanFeatures.i) {
            var d = a('<span class="select-info"/>'), e = function (c, e) {
                d.append(a('<span class="select-item"/>').append(b.i18n("select." + c + "s", {
                    _: "%d " + c + "s selected",
                    0: "",
                    1: "1 " + c + " selected"
                }, e)))
            };
            e("row", b.rows({selected: !0}).flatten().length), e("column", b.columns({selected: !0}).flatten().length), e("cell", b.cells({selected: !0}).flatten().length), a.each(c.aanFeatures.i, function (b, c) {
                c = a(c);
    ...
    function j(b) {
        ...
        b.aoRowCreatedCallback.push({
            fn: function (c, d, e) {
                var f, g, h = b.aoData[e];
                for (h._select_selected && a(c).addClass(b._select.className), f = 0, g = b.aoColumns.length; g > f; f++) (b.aoColumns[f]._select_selected || h._selected_cells && h._selected_cells[f]) && a(h.anCells[f]).addClass(b._select.className)
            }, sName: "select-deferRender"
        }), c.on("preXhr.dt.dtSelect", function () {
            var a = c.rows({selected: !0}).ids(!0).filter(function (a) {
                return a !== d
            ...
            c.one("draw.dt.dtSelect", function () {
                c.rows(a).select(), b.any() && b.each(function (a) {
    ...
    function k(b, c, d, e) {
        var f = b[c + "s"]({search: "applied"}).indexes(), g = a.inArray(e, f), h = a.inArray(d, f);
    ...
    function m(a, b, c, d, f) {
        var g = b.select.style(), h = b[d](f, {selected: !0}).any();
        if ("os" === g) if (a.ctrlKey || a.metaKey) b[d](f).select(!h); else if (a.shiftKey) "cell" === d ? e(b, f, c._select_lastCell || null) : k(b, d, f, c._select_lastCell ? c._select_lastCell[d] : null); else {
    ...
    o.select = {}, o.select.version = "1.1.2", o.select.init = function (b) {
        var c = b.settings()[0], e = c.oInit.select, f = o.defaults.select, g = e === d ? f : e, h = "row", i = "api",
            j = !1, k = !0, l = "td, th", m = "selected";
        c._select = {}, g === !0 ? i = "os" : "string" == typeof g ? i = g : a.isPlainObject(g) && (g.blurable !== d && (j = g.blurable), g.info !== d && (k = g.info), g.items !== d && (h = g.items), g.style !== d && (i = g.style), g.selector !== d && (l = g.selector), g.className !== d && (m = g.className)), b.select.selector(l), b.select.items(h), b.select.style(i), b.select.blurable(j), b.select.info(k), c._select.className = m, a.fn.dataTable.ext.order["select-checkbox"] = function (b, c) {
    ...
    }, a.each([{type: "row", prop: "aoData"}, {type: "column", prop: "aoColumns"}], function (a, b) {
        o.ext.selector[b.type].push(function (a, c, e) {
            var f, g = c.selected, h = [];
            if (g === d) return e;
        ...
        var e, f = b.selected, g = [];
        if (f === d) return c;
        for (var h = 0, i = c.length; i > h; h++) e = a.aoData[c[h].row], (f === !0 && e._selected_cells && e._selected_cells[c[h].column] === !0 || f === !1 && (!e._selected_cells || !e._selected_cells[c[h].column])) && g.push(c[h]);
        return g
    });
    var p = o.Api.register, q = o.Api.registerPlural;
    return p("select()", function () {
        return this.iterator("table", function (a) {
            o.select.init(new o.Api(a))
        })
    }), p("select.blurable()", function (a) {
        return a === d ? this.context[0]._select.blurable : this.iterator("table", function (b) {
            b._select.blurable = a
        })
    }), p("select.info()", function (a) {
        return i === d ? this.context[0]._select.info : this.iterator("table", function (b) {
            b._select.info = a
        })
    }), p("select.items()", function (a) {
        return a === d ? this.context[0]._select.items : this.iterator("table", function (b) {
            b._select.items = a, h(new o.Api(b), "selectItems", [a])
        })
    }), p("select.style()", function (a) {
        return a === d ? this.context[0]._select.style : this.iterator("table", function (b) {
            b._select.style = a, b._select_init || j(b);
            var c = new o.Api(b);
            f(c), "api" !== a && g(c), h(new o.Api(b), "selectStyle", [a])
        })
    }), p("select.selector()", function (a) {
        return a === d ? this.context[0]._select.selector : this.iterator("table", function (b) {
            f(new o.Api(b)), b._select.selector = a, "api" !== b._select.style && g(new o.Api(b))
        })
    }), q("rows().select()", "row().select()", function (b) {
        var c = this;
        return b === !1 ? this.deselect() : (this.iterator("row", function (b, c) {
        ...
        var c = this;
        return b === !1 ? this.deselect() : (this.iterator("column", function (b, c) {
        ...
        var c = this;
        return b === !1 ? this.deselect() : (this.iterator("cell", function (b, c, e) {
            l(b);
            var f = b.aoData[c];
        ...
        return this.iterator("column", function (b, c) {
            ...
            var d = new o.Api(b), e = d.column(c);
            a(e.header()).removeClass(b._select.className), a(e.footer()).removeClass(b._select.className), d.cells(null, c).indexes().each(function (c) {
                var d = b.aoData[c.row], e = d._selected_cells;
        ...
        selectAll: {
            text: n("selectAll", "Select all"), className: "buttons-select-all", action: function () {
                var a = this.select.items();
                this[a + "s"]().select()
            }
        },
        selectNone: {
            text: n("selectNone", "Deselect all"), className: "buttons-select-none", action: function () {
                l(this.settings()[0], !0)
            }, init: function (a, b, c) {
                var d = this;
                a.on("draw.dt.DT select.dt.DT deselect.dt.DT", function () {
